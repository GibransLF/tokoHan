    ...
    <x-slot name="header">
        <div class="flex justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <a href="{{ route("manageProduk.index") }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">{{$kodeProduk}}</a>&nbsp;/&nbsp;{{ __('stok') }}
            </h2>
    ...
    <div class="py-12">
        ...
        @endif
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <a href="{{route('stok.create', $kodeProduk)}}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Tambah Stok</a>
                    <x-table>
                        <x-slot name='header'>
                            <tr>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td>
                                <a href="{{ route("stok.edit", ["kodeProduk" => $kodeProduk, "id" => $stok->id]) }}" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Ubah</a>
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <form method="post" action="{{ route("stok.destroy", ["kodeProduk" => $kodeProduk, "id" => $stok->id] ) }}">
                                                @csrf
                                                @method("DELETE")
